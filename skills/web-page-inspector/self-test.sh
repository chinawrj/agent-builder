...
document.body.innerHTML = '<div id=\"dynamic\">loaded</div>';
</script></body></html>'''
page.goto(f'data:text/html,{html}')
page.wait_for_selector('#dynamic')
text = page.evaluate('document.getElementById(\"dynamic\").textContent')
